<template>
    <div style="backgroundImage: url('/classAttendance/img/front-img-bg.jpg');background-size:cover;">
        <div class="container">
            <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
                <h1 class="h1" style="color:#000;fontSize:28px;">高校学生课堂考勤系统注册</h1>
                <el-form class="rgs-form" label-width="120px">
                       ...
                       <el-form-item class="select" label="班级">
                            <el-select style="width: 300px" v-model="ruleForm.clazzId" placeholder="请选择班级">
                                <el-option
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            //// 学生 的 班级
                            // if((!this.ruleForm.clazzId)&& 'yonghu'==this.tableName){
